...
#ifndef CHALLENGE2_WORDLADDER_WORDLADDER_H
#define CHALLENGE2_WORDLADDER_WORDLADDER_H
...
private:
    ...
    void stackRev(stack<string>& st, ofstream& file);
public:
...
#endif //CHALLENGE2_WORDLADDER_WORDLADDER_H
